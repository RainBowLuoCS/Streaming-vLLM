...
def main():
    ...
    parser.add_argument('--prediction_jsonl', type=str, required=False, default='./results/livesports3k/vllm_baseline/predictions.jsonl',help='Path to model predictions in JSONL format')
    ...
    parser.add_argument('--baseline_jsonl', type=str, required=False, default='./results/livesports3k/livecc_baseline/Gemini-1.5-pro.jsonl',help='Baseline model predictions in JSONL format')
